...
<head>
    ...
    <title>500 — Server Error | AgriPool</title>
...
<body class="font-sans antialiased bg-gray-50 flex items-center justify-center min-h-screen">
    <div class="text-center px-4">
        ...
        <h2 class="text-2xl font-bold text-gray-800 mb-4">{{ __('Engine Trouble') }}</h2>
        <p class="text-gray-500 max-w-md mx-auto mb-8">{{ __('Something went wrong on our end. Our team has been notified. Please try again in a few minutes.') }}</p>
